...
@interface WGForgetPassSetPassView ()
...
@end
@implementation WGForgetPassSetPassView

- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.field_pass1 = [self fieldWithPlaceholder:@"设置密码"];
        self.field_pass1.secureTextEntry = YES;
        [self addSubview:self.field_pass1];
        
        self.field_pass2 = [self fieldWithPlaceholder:@"确认密码"];
